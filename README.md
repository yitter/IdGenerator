...
```
129053495681099        (运行1年，15个占位长度)
387750301904971        (运行3年，15个占位长度)
646093214093387        (运行5年，15个占位长度)
1292658282840139       (运行10年，16个占位长度)
9007199254740992       (运行70年，达到 js Number 最大值，16个占位长度)
165399880288699493     (普通雪花算法运行1年生成的ID，18个占位长度)
```
